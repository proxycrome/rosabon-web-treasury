...
const CompanyDoc = ({
	...
	const handleSubmit = async (e) => {
		...
		let data = {
			...
			contactPersonIdNumber: idNumber,
			idType,
		...
		<div>
			...
			<form autoComplete="off" onSubmit={handleSubmit}>
				<WrapperBody>
					...
					<div>
						<div>
							{companyDocs?.contactPersonIdImage?.imageUrl ? (
									...
									{!base64File.frontEncodedString ? (
										<div className="d-flex align-items-center justify-content-between">
											<div className="d-flex align-items-center justify-content-center">
												...
												/>
												<div>
													<h5 className="">Upload Company Contact Person ID</h5>
							...
							{companyDocs?.certificateOfIncoImage?.imageUrl ? (
								<div className="row pb-4">
									<div className="d-flex align-items-center justify-content-between">
										<div className="d-flex align-items-center justify-content-center">
											<img
									...
									{!base64File.certOfIncoEncodedString ? (
										<div className="d-flex align-items-center justify-content-between">
											<div className="d-flex align-items-center justify-content-center">
												...
												<div>
													<h5 className="">
														Upload Company/Business Certificate of Incorporation
													</h5>
													<h5 className="">jpg, pdf, 2 MB</h5>
												</div>
											</div>
							...
							{companyDocs?.utilityBillImage?.imageUrl ? (
								<div className="row pb-4">
									<div className="d-flex align-items-center justify-content-between">
										<div className="d-flex align-items-center justify-content-center">
											<img
