										...
										<div className="row d-flex">
											<div className="col-8 mb-4">
												...
												<small className="text-danger">
													{bvnError?.message && id === 1 ? bvnError?.message : ""}
												</small>
												{errors.bvn && (
                  ...
                  <hr />
									<div className="row mt-5">
										<div className="d-flex justify-content-between mt-5">
											<h4>
												Director {data.no}{" "}
												<span className="pl-5" onClick={() => t_col1(data.id)}>
													{col1 ? (
														<i className="fa-solid fa-angle-down arrow"></i>
													) : (
														<i className="fa-solid fa-angle-up arrow"></i>
											...
											<div>
												...
												<button
													...
													onClick={() => deleteDirector(data.id)}>
													...
													{!data.idDocumentImage?.encodedUpload ? (
														...
														<div className="d-flex align-items-center justify-content-between w-100">
															...
															<div className="style-attachment">
																...
																/>
																{!showEdit ? // 	}> // 		handleFileSelect(e, frontFileInputRef) // 	onClick={(e) => // 	className="btn_bg_blue" // 	type="button" // <button
																// 	Choose file
																// </button>
																null : (
																	<button
